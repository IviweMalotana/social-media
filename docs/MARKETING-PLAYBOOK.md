...
|---|---|---|---|
| Cold B2B outreach | Prospects who never heard of us | Campaigns + Outreach pages | 15/day cap, 3 emails then stop, review queue, stop-on-reply, suppression forever |
| Owned list | Customers + subscribers who opted in | Resend Broadcasts (shop side) | 2–4/month, plain text, from hello@/ivi@, never orders@ |
| Social + ads | Everyone else | Composer / Studio / Calendar | Consistency > virality; social is trust + retargeting fuel |

Cold infrastructure must never send list-style promos, and the list must never
receive cold sequences. Different laws, different caps, different reputations.

## Lessons adopted (and what we ignore)
...
## Launch sequence template (copy per product event)

Day 0 tease → Day 3–5 launch → Day 10–14 momentum. One Studio session
produces all three visuals at once. Email list gets tease + launch (shop side,
Resend Broadcast); back-in-stock emails fire from the shop automatically.
...
- Social: clicks and impressions trending up, posting streak unbroken.
- List: subscriber count growing monthly (manual target on the shop side).
- Cold B2B: reply rate ≥ 2% by 200 sends, else change segment/copy (kill
  criterion is enforced on the Outreach page).
- Revenue: recurring B2B accounts compounding toward R15k/month.
