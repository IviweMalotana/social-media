...
export const EMAIL_TEMPLATES: EmailTemplate[] = [
...

  {
    ...
    description:
      'Founder intro leading. Trust anchor first (Etsy origin + Ivy quote), three format categories with images, values row, honest shipping close. Rewired to put "who this is for" and founder trust in the first two blocks.',
    subject: 'meet bdp.',
    ...
    blocks: [
      ...
      {
        type: 'storyImage',
        heading: 'Started on Etsy at 4.9 stars because small brands kept getting quoted like they didn\'t matter.',
        body: 'BDP is the supplier I wished existed then. Every format we stock is one I\'d put my own product in.\n\nXo, Ivi',
      ...
      },
      {
        ...
        rows: [
          ...
          { metric: 'Time to first launch', ours: '5-14 days', theirs: '8-16 weeks' },
          { metric: 'Branded run', ours: '2,500 units', theirs: '10,000+ units' },
          { metric: 'Integration required', ours: 'None. Order in the browser.', theirs: 'Quote thread + PO + email chain' },
        ],
      },
      {
        type: 'text',
        heading: 'Not for you if',
        body: 'You want someone else to formulate your product. BDP sells packaging, not private-label finished goods. If you\'re at the "help me make the product" stage, a private-label platform is a better fit for now. We\'re the supplier you graduate to when you own your formula.',
      },
      {
        type: 'card',
        title: 'DROPPERS',
      ...
      {
        type: 'text',
        heading: 'Made in [country]. Shipped factory direct to your door.',
        body: '[One or two honest sentences on manufacturing standards, quality checks, or certifications you actually meet. Fill in the country and any real certifications before sending. Leave the standing supply and shipping close below unchanged.]',
        bg: 'sand',
      },
      {
        type: 'text',
        heading: 'Ships tracked in 5 to 14 business days (Air Express).',
        body: 'Cheaper Standard option at checkout. Duties settled at delivery for international orders.',
      },
    ],
  },

  {
    ...
    blocks: [
      ...
      {
        type: 'comparison',
        title: 'How this format compares',
        ourLabel: 'bdp',
        theirLabel: 'Typical supplier',
        rows: [
          { metric: 'MOQ', ours: '10 units', theirs: '500+ units' },
...

  {
    ...
    blocks: [
      ...
      },
      {
        ...
        imageUrl: IMG('amber-bottle-60ml.webp'),
      },
      {
        type: 'card',
...

  {
    ...
    blocks: [
      ...
      {
        type: 'comparison',
        title: 'Why our sale is worth catching',
        ourLabel: 'bdp',
        theirLabel: 'Typical supplier',
        rows: [
          { metric: 'MOQ', ours: '10 units', theirs: '500+ units' },
          { metric: 'Sale MOQ', ours: '10 units', theirs: 'Same as full price' },
          { metric: 'Stock delivery', ours: '5-14 days', theirs: 'Weeks' },
        ],
      },
      {
  ...
  {
    key: 'sample-pack',
    name: 'Sample pack (risk reversal)',
    description:
      'The offer for buyers stuck in "which format?" limbo. Positions the 10-unit MOQ as a real test order. Uses the comparison block to make risk reversal tangible: R[amount] to try 4 formats vs R[amount] committed to guessing wrong. Michelle\'s samples-then-order Etsy review sits mid-flow as proof this works.',
    subject: 'not sure which format fits your formula?',
    preheader: 'test 4 formats at 10 units each. Reorder what worked.',
    blocks: [
      { type: 'offerBar', text: '10 UNITS PER FORMAT. NO 500 UNIT GAMBLE.' },
      { type: 'logo' },
      {
        type: 'hero',
        headline: 'NOT SURE WHICH FORMAT FITS?\nTEST 4 AT 10 UNITS.',
        subline:
          'Order dropper + jar + pump + amber bottle at 10 units each. Test with your real formula. Reorder what worked.',
        imageUrl: IMG('dropper-frosted-gold.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      {
        type: 'text',
        heading: 'The problem isn\'t packaging. It\'s ordering 500 units of the wrong format and finding out too late.',
        body: 'Most suppliers make the test order impossible. We built the opposite. Every format on the site is orderable at 10 units. Live pricing, no quote request, tracked delivery in 5 to 14 business days.',
      },
      {
        type: 'comparison',
        title: 'Testing packaging shouldn\'t be a gamble',
        ourLabel: 'bdp',
        theirLabel: 'Typical supplier',
        rows: [
          { metric: 'Test order', ours: '10 units', theirs: '500+ units' },
          { metric: 'Test 4 formats', ours: '40 units total', theirs: '2,000+ units total' },
          { metric: 'Pricing', ours: 'Live on site', theirs: 'Quote request' },
          { metric: 'Delivery', ours: '5-14 days tracked', theirs: 'Weeks' },
        ],
      },
      {
        type: 'iconRow',
        title: 'Your 4-format test order',
        items: [
          { icon: '💧', label: 'DROPPER' },
          { icon: '🫙', label: 'JAR' },
          { icon: '🧴', label: 'BOTTLE' },
      ...
      },
      {
        type: 'card',
        title: 'DROPPER',
        body: 'Best for serums, oils, actives. 30ml or 50ml. Test the fill, the dose, the finish.',
        imageUrl: IMG('dropper-black.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      {
        type: 'card',
        title: 'JAR',
        body: 'Best for balms, masks, solid formulas. Amber glass with UV protection or frosted white.',
        imageUrl: IMG('jar-brown-wood.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      {
        type: 'card',
        title: 'AMBER BOTTLE',
        body: 'Best for tinctures, oils, and light-sensitive formulas. 60ml amber glass.',
        imageUrl: IMG('amber-bottle-60ml.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      {
        type: 'card',
        title: 'PUMP / SPRAYER',
        body: 'Best for lotions, moisturisers, toners. Airless or standard, lock during transit.',
        imageUrl: IMG('sprayer-round.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      ...
      {
        type: 'text',
        heading: 'What to do with the test order',
        body: 'Fill with your real formula. Photograph the finish. Check the mechanism (dose, spray, seal). Order 500 of the winner. Skip the rest. Ships tracked in 5 to 14 business days.',
        bg: 'sand',
      },
      {
        type: 'hero',
        headline: 'TEST BEFORE YOU COMMIT.',
        subline: 'Every format from 10 units. No quote round trips.',
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
    ],
  ...
  {
    key: 'outgrown-private-label',
    name: 'Outgrown private label',
    description:
      'The graduation email. Targets founders who started on a private-label / dropshipping platform, hit its ceiling (someone else\'s formula, someone else\'s catalog, someone else\'s label templates), and are ready to run their own product in their own bottles. Positions BDP as the upgrade, not the alternative.',
    subject: 'outgrown private label?',
    preheader: 'the supplier you graduate to when you own your formula.',
    blocks: [
      { type: 'offerBar', text: 'TAKE 10% OFF YOUR FIRST ORDER WITH CODE TRYBDP10' },
      { type: 'logo' },
      {
        type: 'hero',
        headline: 'OUTGROWN PRIVATE LABEL?\nRUN YOUR OWN FORMULA IN YOUR OWN BOTTLES.',
        subline:
          'The supplier you graduate to when you own your formula. From 10 units. Live tiered pricing. Tracked delivery in 5 to 14 business days.',
        imageUrl: IMG('dropper-frosted-gold.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      {
        type: 'text',
        heading: 'Private label got you launched. It won\'t get you differentiated.',
        body: 'Someone else\'s formula. Someone else\'s catalog. Someone else\'s label templates. The margin math works when you\'re starting. It stops working the moment a customer asks what makes your product different, or the moment you outgrow the catalog.\n\nBDP is the next step. You bring the formula, we ship the bottles.',
      },
      {
        type: 'comparison',
        title: 'What changes when you own the product',
        ourLabel: 'bdp',
        theirLabel: 'Private label',
        rows: [
          { metric: 'Formula', ours: 'Yours', theirs: 'Their catalog' },
          { metric: 'Label options', ours: 'Silk screen or hot stamp', theirs: 'Template print' },
          { metric: 'MOQ per SKU', ours: '10 empty units', theirs: '50+ finished units' },
          { metric: 'Margin', ours: 'Packaging cost only', theirs: 'They take a per-unit cut' },
          { metric: 'Scale path', ours: 'Same site, tier discounts', theirs: 'New negotiations' },
        ],
      },
      {
        type: 'proof',
      ...
      {
        type: 'iconRow',
        title: 'What you gain when you graduate',
        items: [
          { icon: '🧪', label: 'YOUR FORMULA' },
          { icon: '🏷️', label: 'CUSTOM BRANDING' },
          { icon: '💰', label: 'YOUR MARGIN' },
      ...
      {
        type: 'text',
        heading: 'Start with 10 of each format to see if the finish fits your brand.',
        body: 'Order a dropper, a jar, a pump. Fill with your real formula. Photograph. Decide. Reorder what worked. No commitment to a full run until you\'re ready.',
      },
      {
        type: 'card',
        title: 'DROPPER',
        body: 'Best for serums, oils, actives. Glass body, rubber teat. From 10 units.',
        imageUrl: IMG('dropper-black.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      {
        type: 'card',
        title: 'JAR',
        body: 'Best for balms, masks, solid formulas. Amber, frosted, or matte white. From 10 units.',
        imageUrl: IMG('jar-brown-wood.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      {
        type: 'card',
        title: 'PUMP / SPRAYER',
        body: 'Best for lotions, moisturisers, toners. Airless or standard. From 10 units.',
        imageUrl: IMG('sprayer-round.webp'),
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
      },
      {
        ...
        body: 'BDP is the supplier I wished existed when I was small. Started on Etsy at 4.9 stars because small brands kept getting quoted like they didn\'t matter.\n\nXo, Ivi',
        imageUrl: IMG('frosted-white.webp'),
        bg: 'blush',
        ctaText: 'BE STOCKED',
        ctaUrl: SHOP,
